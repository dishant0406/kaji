...
struct MarkdownCodeBlockHighlighterTests {
    ...
    func replacesSwiftFence() {
        ...
        #expect(result.contains("<pre class=\"droid-prehl\">"))
        #expect(result.contains("droid-hl-lang-swift"))
        #expect(result.contains("droid-tok-keyword"))
    ...
    func skipsMermaid() {
        ...
        #expect(!result.contains("droid-prehl"))
    }
