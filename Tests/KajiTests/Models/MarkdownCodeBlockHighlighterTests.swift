...
struct MarkdownCodeBlockHighlighterTests {
    ...
    func replacesSwiftFence() {
        ...
        #expect(result.contains("<pre class=\"kaji-prehl\">"))
        #expect(result.contains("kaji-hl-lang-swift"))
        #expect(result.contains("kaji-tok-keyword"))
    ...
    func skipsMermaid() {
        ...
        #expect(!result.contains("kaji-prehl"))
    }
