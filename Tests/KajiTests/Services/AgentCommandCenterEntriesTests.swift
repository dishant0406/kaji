...
struct AgentCommandCenterEntriesTests {
    ...
    func runningRunExposesAllKeyboardActions() {
        let file = AgentChangedFile(path: "Kaji/App.swift", oldPath: nil, status: .modified, additions: 4, deletions: 1, isBinary: false)
    ...
    func deletedFilesExposeDiffButNotOpenFile() {
        let file = AgentChangedFile(path: "Kaji/Old.swift", oldPath: nil, status: .deleted, additions: 0, deletions: 8, isBinary: false)
