...
struct OpenCodeProviderTests {
    ...
    func pluginPathsIncludeCurrentAndLegacyDirectories() {
        ...
        #expect(paths == [
            "/tmp/home/.config/opencode/plugins/kaji-notify.js",
            "/tmp/home/.opencode/plugins/kaji-notify.js",
        ])
    }
    ...
    func installCopiesLatestPluginToCurrentAndLegacyDirectories() throws {
        ...
        try """
        export const KajiNotificationPlugin = async () => ({
          event: async ({ event }) => {
        ...
        for path in OpenCodeProvider.pluginPaths(homeDirectory: homeDir.path) {
            ...
            #expect(text.contains("KAJI_PROJECT_ID"))
            #expect(text.contains("KAJI_WORKTREE_ID"))
        }
        ...
        #expect(configText.contains("kaji-notify.js"))
    }
