...
struct CodingAgentShimInstallerTests {
    ...
    func removesBrowserMCPWhenBrowserIsDisabled() throws {
        ...
        #expect(fileManager.fileExists(atPath: enabled.appendingPathComponent("kaji-browser-mcp").path))
        ...
        #expect(!fileManager.fileExists(atPath: disabled.appendingPathComponent("kaji-browser-mcp").path))
        #expect(!fileManager.fileExists(atPath: disabled.appendingPathComponent("kaji-browser").path))
    }
