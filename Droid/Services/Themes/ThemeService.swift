...
final class ThemeService {
    ...
    nonisolated private static let selectedThemeNameKey = "droid.selectedThemeName"
    ...
    private let config: DroidConfig
    ...
    func prepareDraft() -> ThemeDraft {
        let seed = currentThemePreview()?.draft ?? ThemeDraft.droidDefaults
