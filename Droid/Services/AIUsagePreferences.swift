...
enum AIUsageProviderTrackingStore {
    static func trackingKey(providerID: String) -> String {
        "droid.usage.provider.\(canonicalAIUsageProviderID(providerID)).tracked"
    }
...
enum AIUsageProviderEnabledStore {
    static func enabledKey(providerID: String) -> String {
        "droid.usage.provider.\(canonicalAIUsageProviderID(providerID)).enabled"
    }
...
enum AIUsageSettingsStore {
    static let autoRefreshIntervalKey = "droid.usage.autoRefreshIntervalSeconds"
    static let usageDisplayModeKey = "droid.usage.displayMode"
    static let usageEnabledKey = "droid.usage.enabled"
    static let showSecondaryLimitsKey = "droid.usage.showSecondaryLimits"
    static let sidebarPreviewProviderIDKey = "droid.usage.sidebarPreviewProviderID"
