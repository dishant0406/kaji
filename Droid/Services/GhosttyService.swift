...
private let logger = Logger(subsystem: "app.droid", category: "GhosttyService")
...
final class GhosttyService {
    ...
    @ObservationIgnored private let droidConfig: DroidConfig
    ...
    private func initializeGhostty() {
        ...
        guard let cfg = loadDroidGhosttyConfig() else {
    ...
    func reloadConfig() {
        ...
        guard let newConfig = loadDroidGhosttyConfig() else { return }
    ...
    private func loadDroidGhosttyConfig() -> ghostty_config_t? {
        guard let cfg = ghostty_config_new() else { return nil }
        let configPath = droidConfig.ghosttyConfigPath
