...
struct DroidCodeGraphLayout {
    let positions: [String: CGPoint]

    init(document: DroidCodeGraphDocument, size: CGSize, nodeOffsets: [String: CGSize] = [:]) {
    ...
    private static func placeMembers(_ members: [DroidCodeGraphNode], center: CGPoint, result: inout [String: CGPoint]) {
