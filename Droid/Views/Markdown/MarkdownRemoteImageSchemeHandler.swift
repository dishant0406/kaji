...
private let remoteImageLogger = Logger(subsystem: "app.droid", category: "MarkdownRemoteImage")
...
final class MarkdownRemoteImageSchemeHandler: NSObject, WKURLSchemeHandler {
    static let scheme = "droid-md-remote"
    ...
    private static let userAgent = "Droid/1.0 (Markdown Preview)"
    ...
    private static func cacheDirectory() -> URL? {
        ...
        let directory = baseURL.appendingPathComponent("Droid", isDirectory: true).appendingPathComponent(
            cacheDirectoryName,
            isDirectory: true
        )
