...
struct NativeMarkdownView: View {
    ...
    private func managedBlock(title: String, content: String) -> some View {
        VStack(alignment: .leading, spacing: 12) {
            HStack(spacing: 8) {
                DroidIcon(systemName: "puzzlepiece.extension", size: 13)
        ...
        .overlay {
            RoundedRectangle(cornerRadius: 12).stroke(DroidTheme.border, lineWidth: 1)
        }
    }

    private var droidTheme: Theme {
        Theme()
            .text {
                ForegroundColor(DroidTheme.fg)
            ...
            .code {
                ...
                FontSize(.em(0.88))
                ForegroundColor(DroidTheme.fg)
                BackgroundColor(DroidTheme.secondaryBackground)
            }
            .strong { FontWeight(.semibold) }
            .link { ForegroundColor(DroidTheme.accent) }
            ...
            .blockquote { configuration in
                HStack(spacing: 0) {
                    ...
                    configuration.label
                        .markdownTextStyle { ForegroundColor(DroidTheme.fgMuted) }
            ...
            .codeBlock { configuration in
                ...
                .overlay {
                    RoundedRectangle(cornerRadius: 8).stroke(DroidTheme.border, lineWidth: 1)
                }
                .markdownMargin(top: 0, bottom: 14)
            }
            ...
            .table { configuration in
                configuration.label
                    .fixedSize(horizontal: false, vertical: true)
                    .markdownTableBorderStyle(.init(color: DroidTheme.border))
                    .markdownTableBackgroundStyle(.alternatingRows(DroidTheme.bg, DroidTheme.secondaryBackground))
                    .markdownMargin(top: 0, bottom: 14)
            }
        ...
        VStack(alignment: .leading, spacing: 6) {
            configuration.label
                ...
                .markdownTextStyle {
                    FontWeight(.semibold)
                    FontSize(.em(size))
                    ForegroundColor(muted ? DroidTheme.fgMuted : DroidTheme.fg)
                }
            if divider {
