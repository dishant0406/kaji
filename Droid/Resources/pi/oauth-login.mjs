...
// Vendor/pi-mono/packages/droid-agent/src/oauth-login.ts
import { chmodSync, existsSync, mkdirSync, readFileSync, writeFileSync } from "node:fs";
import { homedir } from "node:os";
import { dirname, join } from "node:path";
import readline from "node:readline";

// Vendor/pi-mono/packages/ai/src/utils/oauth/oauth-page.ts
...
// Vendor/pi-mono/packages/ai/src/utils/oauth/pkce.ts
...
// Vendor/pi-mono/packages/ai/src/utils/oauth/anthropic.ts
var nodeApis = null;
...
var CALLBACK_HOST = process.env.PI_OAUTH_CALLBACK_HOST || "127.0.0.1";
...
// Vendor/pi-mono/packages/ai/src/models.generated.ts
var MODELS = {
  "amazon-bedrock": {
...
// Vendor/pi-mono/packages/ai/src/models.ts
...
// Vendor/pi-mono/packages/ai/src/utils/oauth/github-copilot.ts
...
// Vendor/pi-mono/packages/ai/src/utils/oauth/openai-codex.ts
...
function startLocalOAuthServer(state) {
  ...
  return new Promise((resolve) => {
    server.listen(1455, CALLBACK_HOST2, () => {
      ...
      console.error(
        `[openai-codex] Failed to bind http://${CALLBACK_HOST2}:1455 (`,
        err.code,
...
// Vendor/pi-mono/packages/ai/src/utils/oauth/index.ts
...
function requestInput(message, placeholder, allowEmpty) {
  const id = createID();
  const promise = new Promise((resolve) => pendingPrompts.set(id, resolve));
