        ...
        CommandGroup(after: .appSettings) {
            Button {
                ...
                Label {
                    ...
                    DroidIcon(systemName: "doc.text", size: 12)
                }
            }
            ...
            Button {
                ...
                Label {
                    ...
                    DroidIcon(systemName: "arrow.clockwise", size: 12)
                }
            }
            ...
            Button {
                ...
                Label {
                    ...
                    DroidIcon(systemName: "arrow.triangle.2.circlepath", size: 12)
                }
            }
