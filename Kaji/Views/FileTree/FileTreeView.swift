    ...
    private var header: some View {
        HStack(spacing: 8) {
            ...
            IconButton(
                ...
                color: state.showOnlyChanges ? KajiTheme.accent : KajiTheme.fgMuted,
                hoverColor: state.showOnlyChanges ? KajiTheme.accent : KajiTheme.fg,
    ...
    private var dropOverlay: some View {
        if isDropHighlighted {
            RoundedRectangle(cornerRadius: 3)
                .stroke(KajiTheme.accent, lineWidth: 1)
