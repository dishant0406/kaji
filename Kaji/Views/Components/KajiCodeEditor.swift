...
struct KajiCodeEditor: NSViewRepresentable {
    @Binding var text: String
    let language: KajiCodeLanguage
    ...
    func makeNSView(context: Context) -> NSScrollView {
        ...
        scrollView.verticalRulerView = KajiCodeLineNumberRuler(textView: textView)
...
private final class KajiCodeTextView: NSTextView {
