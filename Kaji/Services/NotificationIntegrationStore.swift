...
private let notificationIntegrationLogger = Logger(subsystem: "app.kaji", category: "NotificationIntegrationStore")
...
final class NotificationIntegrationStore {
    ...
    init(
        fileStore: CodableFileStore<NotificationIntegrationSettings> = .init(
            fileURL: KajiFileStorage.fileURL(filename: "notification-integrations.json"),
