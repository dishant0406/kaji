...
enum CodexBrowserMCPConfig {
    static func arguments(for descriptor: KajiBrowserMCPServerDescriptor) -> [String] {
        let values = [
    ...
    static func shellArguments(for descriptor: KajiBrowserMCPServerDescriptor) -> String {
