...
enum KajiCodeGraphDirectory {
    private static let overrideKey = "KAJI_EXTENSIONS_DIR"
    ...
    static var root: URL {
        ...
        return base.appendingPathComponent("kajicodegraph", isDirectory: true)
    }
    ...
    static var adapterScript: URL {
        adapter.appendingPathComponent("kajicodegraph_runner.py")
    }
