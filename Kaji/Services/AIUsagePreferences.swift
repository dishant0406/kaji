...
enum AIUsageProviderTrackingStore {
    static func trackingKey(providerID: String) -> String {
        "kaji.usage.provider.\(canonicalAIUsageProviderID(providerID)).tracked"
    }
...
enum AIUsageProviderEnabledStore {
    static func enabledKey(providerID: String) -> String {
        "kaji.usage.provider.\(canonicalAIUsageProviderID(providerID)).enabled"
    }
...
enum AIUsageSettingsStore {
    static let autoRefreshIntervalKey = "kaji.usage.autoRefreshIntervalSeconds"
    static let usageDisplayModeKey = "kaji.usage.displayMode"
    static let usageEnabledKey = "kaji.usage.enabled"
    static let showSecondaryLimitsKey = "kaji.usage.showSecondaryLimits"
    static let sidebarPreviewProviderIDKey = "kaji.usage.sidebarPreviewProviderID"
