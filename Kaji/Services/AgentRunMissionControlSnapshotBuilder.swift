...
enum AgentRunMissionControlSnapshotBuilder {
    static func items(
        runs: [AgentRun],
        notifications: [KajiNotification],
        projects: [Project],
    ...
    static func item(
        run: AgentRun,
        completion: KajiNotification? = nil,
        projects: [Project],
        worktrees: [UUID: [Worktree]],
        now: Date = Date()
    ) -> AgentMissionControlItem {
    ...
    private static func latestCompletion(for run: AgentRun, notifications: [KajiNotification]) -> KajiNotification? {
        notifications
    ...
    private static func isCompletedProviderNotification(_ notification: KajiNotification) -> Bool {
