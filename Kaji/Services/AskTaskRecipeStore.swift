...
private let askTaskRecipeLogger = Logger(subsystem: "app.kaji", category: "AskTaskRecipeStore")
...
final class AskTaskRecipeStore {
    ...
    init(fileStore: CodableFileStore<[AskTaskRecipe]> = CodableFileStore(fileURL: KajiFileStorage.fileURL(filename: "ask-recipes.json"))) {
