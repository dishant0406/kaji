...
struct KajiCommands: Commands {
    ...
    private var terminalPasteboardCommands: TerminalPasteboardCommandRouter {
    ...
    var body: some Commands {
        ...
        CommandGroup(after: .appSettings) {
            Button {
                ...
                Label {
                    ...
                    KajiIcon(systemName: "doc.text", size: 12)
                }
            }
            ...
            Button {
                ...
                Label {
                    ...
                    KajiIcon(systemName: "arrow.clockwise", size: 12)
                }
            }
            ...
            Button {
                ...
                Label {
                    ...
                    KajiIcon(systemName: "arrow.triangle.2.circlepath", size: 12)
                }
            }
        ...
        CommandGroup(replacing: .pasteboard) {
            ...
            Button("Copy") {
                if isMainWindowFocused, terminalPasteboardCommands.copy() { return }
                NSApp.sendAction(#selector(NSText.copy(_:)), to: nil, from: nil)
            }
            .keyboardShortcut("c", modifiers: .command)
            Button("Paste") {
                if isMainWindowFocused, terminalPasteboardCommands.paste() { return }
