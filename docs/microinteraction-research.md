...
- Terminal surface interactions, Termy mouse and keyboard forwarding, terminal search, context menus, file drops, and footer terminal transitions.
...
5. Keep AppKit/Termy/WebKit surfaces native and animate their surrounding SwiftUI chrome instead of trying to animate embedded surfaces directly.
