...
export interface RpcSlashCommandInfo {
	name: string;
	description?: string;
	source: "builtin" | "file" | "skill" | "extension";
	inlineHint?: string;
	argumentHint?: string;
	path?: string;
...
export interface RpcHistoryEntryInfo {
	id: number;
	prompt: string;
	createdAt: number;
	cwd?: string;
...
export type RpcCommand =
	...
	| { id?: string; type: "get_model_config" }
	...
	| { id?: string; type: "list_sessions"; all?: boolean; limit?: number }
	| { id?: string; type: "get_session_tree" }
	| { id?: string; type: "navigate_tree"; entryId: string; summarize?: boolean | string }
	...
	| { id?: string; type: "get_subagent_transcript"; subagentId?: string; fromByte?: number }
	...
	| { id?: string; type: "expand_slash_command"; text: string }
	| { id?: string; type: "get_skills" }
	| { id?: string; type: "build_skill_prompt"; name: string; args?: string }
	| { id?: string; type: "get_prompt_templates" }
	| { id?: string; type: "get_history_recent"; limit?: number }
	| { id?: string; type: "search_history"; query: string; limit?: number }
...
export type RpcSessionInfo = Pick<SessionInfo, "path" | "id" | "cwd" | "title" | "firstMessage" | "messageCount" | "size"> & {
	created: string;
	modified: string;
};
