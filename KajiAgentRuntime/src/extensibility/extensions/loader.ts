...
class ConcreteExtensionAPI implements ExtensionAPI, IExtensionRuntime {
	...
	constructor(
		public readonly pi: typeof import("../legacy-pi-coding-agent-shim"),
...
async function loadExtension(
	...
	try {
		...
		const api = new ConcreteExtensionAPI(
			await import("../legacy-pi-coding-agent-shim"),
			extension,
			runtime,
			cwd,
			eventBus,
...
export async function loadExtensionFromFactory(
	...
	const api = new ConcreteExtensionAPI(await import("../legacy-pi-coding-agent-shim"), extension, runtime, cwd, eventBus);
	await factory(api);
	return extension;
}
